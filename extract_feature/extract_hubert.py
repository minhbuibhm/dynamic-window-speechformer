...
def handle_iemocap(model: Hubert):
    ...
    save_L12 = '/content/drive/MyDrive/speechformer2/iemocap/feature/hubert_large_L12_mat'
    save_L24 = '/content/drive/MyDrive/speechformer2/iemocap/feature/hubert_large_L24_mat'
    ...
    extracted_file_12 = os.listdir(save_L12)
    for session_id in range(1,6):
      directory_path = f'/content/drive/MyDrive/speech_corpus/IEMOCAP/IEMOCAP_full_release/Session{session_id}/sentences/wav (1)'
      folders = os.listdir(directory_path)
      full_paths = [os.path.join(directory_path, content) for content in folders]
