...
def modify_config(cfg, args):
    ...
    print(f"Database, feature: {database}, {feature}")
    ...
    print(f'Database: {database}, feature: {feature}, model type: {modeltype}. Use arguments from train json file: {train_config}')
