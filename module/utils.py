...
def statistical_information(hop=0.01):  # unit: second
    hop = int(hop * 1000)
    Merge = [50,    # shortest duration of phones. Merging scale frames to phone-grained  
             250,   # shortest duration of words. Merging scale phones to word-grained
             1000]  # longest duration of words to roughly simulate the number of words
    # corresponding to the original audio length. (unit: millisecond)
    Locals = [50,   # number of tokens in 50ms (shortest duration of phones)
              400,  # number of tokens in 400ms (twice the longest duration of phones)
              2000] # number of tokens in 2000ms (twice the longest duration of words)
